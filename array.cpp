...
//dektarasi array tanpa ukuran, tetapi wajib mengisikan data
int nilai[] = {12,5,9,10,34};
//deklarasi array dengan ukuran dan diberi nilai awal
int skor[5] = {18,12,18,6};
//dektarasi array dengan ukuran dan tidak ada nilai awal 
string nama [3];
